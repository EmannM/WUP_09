...
The numerical summary of the linear model of Length2 + Height above shows a residual standard error of 53.1 (how far the standard deviation of the model is from that of the normal curve), multiple R-squared of 0.9394 (which means that this model has a strong linear relationship between the two regressors since it is close to 1), and adjusted R-squared of 0.9356 (which is very good since it means that about 94% of the mean model error is explained with this model). This is the best 2-regressor model for predicting the weight of Bream because its R-squared is the highest.  
...
The numerical summary of the linear model of Length2 + Width above shows a residual standard error of 0.7783 (how far the standard deviation of the model is from that of the normal curve), multiple R-squared of 0.97 (which means that this model has a strong linear relationship between the two regressors since it is close to 1), and adjusted R-squared of 0.9645 (which is very good since it means that about 96% of the mean model error is explained with this model). This is the best 2-regressor model for predicting the weight of Smelt because its R-squared is the highest.  
